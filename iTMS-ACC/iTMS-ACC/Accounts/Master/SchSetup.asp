							  ...
							  <tr>
								<td class="FieldCellSub" width="50">Schedule</td>
										<td class="FieldCell" colspan="2">
											...
											<%
												sQuery = "Select Distinct ScheduleID,RTRIM('Schedule-'+Cast(ScheduleNumber as Char)) ScheduleNo, "&_
														 "ScheduleHeading,Hierarchy From Vw_Acc_SchSetup Where ApplicableFor='L' "&_
										...
										<tr>
											...
											<td><Input type="Button" value="Schedule Setup" class="ActionButtonX" id=button4 name=ButAddSchedHeads onclick="SchdSetupPopUp('BS')"></td>
...
<%		 Else 'IF There is No SubSubID For the SchSubID then Check Wheather the "SubHead Name is NULL
			...
			'Response.Write "<p style='color:red'>" & CStr(Objrs1("EntryType"))
									...
									<table border="0" cellpadding="0" cellspacing="0" width="100%">
										<tr>
											<td valign="middle" class="ActionCell">
                                                ...
                                                <input type="button" value="Schedule View" name="But_View" class="ActionButtonX" onClick="ViewSchedule('L')">
