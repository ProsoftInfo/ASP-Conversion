...
'			msgbox sOrgID&sFinyr&sschedno&"'"&splt2(0)&"'"&splt1(1)&"'"&id
			...
			IF objhttp.responsexml.XML <> "" Then
			objhttp2.Open "Post","XMLSave.asp?Name=SchedPLBrkSubHeads&Mod=Acc", false
			'MsgBox objhttp.responsexml.XML
...
Function popAccList()
	...
	Dim iPLHead,iPlSubHd,iPlSubSubHd
	iPLHead = document.formname.selSch.value
	iPlSubHd = document.formname.selLevel1.value
	IF document.formname.optLevel(1).checked = True Then
		iPlSubSubHd = document.formname.selLevel2.value
	Else
		iPlSubSubHd = 0
	End IF
	sOrgId = document.formname.hOrgId.value
	...
	ElseIf	document.formname.optMode(2).checked = True Then
		OutValue= showModalDialog("SelAccPLHeadName.asp?orgId="+sOrgId&"&PLHead="&iPLHead&"&PLSubHd="&iPlSubHd&"&PlSubSubHd="&iPlSubSubHd,"A","dialogHeight:460px;dialogWidth:550px;center:Yes;help:No;resizable:Yes;status:No")
	End If
End Function
...
Function SaveXML()
	...
	IF CheckVal() Then
		...
		'MsgBox XMLData.XML
		objhttp.Open "Post","XMLSchPLHeadSave.asp?Name=SchedPLSubHeads&Mod=Acc", false
