...
'					 " and OUDefinitionID='"&sOrgId&"' order by AccountDescription"
'elseif sFilter <> "%" and CStr(sBookCode) = "04" then
'	oDataList.sSQL = "select Distinct AccountDescription,AccountHead,AccountHeadCode from VwOrgGLHeads where AccountHead "&_
'					 "not in (select BookAccountHead from Acc_R_ApplicableAccountHeads where BookAccountHead is not null and OUDefinitionID='"&sOrgId&"' and Useable <> '1')"&_
'					 " and OUDefinitionID='"&sOrgId&"' and AccountDescription Like '"&sFilter&"' order by AccountDescription"
...
'	oDataList.sSQL = "select Distinct AccountDescription,AccountHead,AccountHeadCode from VwOrgGLHeads where AccountHead "&_
'					 "not in (select BookAccountHead from Acc_R_ApplicableAccountHeads where BookAccountHead is not null and OUDefinitionID='"&sOrgId&"')"&_
'					 " and OUDefinitionID='"&sOrgId&"' order by AccountDescription"
'Elseif sFilter <> "%" and CStr(sBookCode) <> "04" and CStr(sBookCode) <> "05" Then
'	oDataList.sSQL = "select Distinct AccountDescription,AccountHead,AccountHeadCode from VwOrgGLHeads where AccountHead "&_
'					 "not in (select BookAccountHead from Acc_R_ApplicableAccountHeads where BookAccountHead is not null and OUDefinitionID='"&sOrgId&"')"&_
...
if sFilter = "%" Then
	oDataList.sSQL = "select Distinct AccountDescription,AccountHead,AccountHeadCode from VwOrgGLHeads where "&_
					 " OUDefinitionID='"&sOrgId&"' order by AccountDescription"
Else
	oDataList.sSQL = "select Distinct AccountDescription,AccountHead,AccountHeadCode from VwOrgGLHeads where "&_
					 " OUDefinitionID='"&sOrgId&"' and AccountDescription Like '"&sFilter&"'  order by AccountDescription"
End IF
