...
Function ViewPL()
    ...
    win = open ( "View_ProfitAndLoss_Acc.asp" & "?" & sTempValues, "",sOptions)
End Function
	...
	Dim sOrgId,sSchedName,sInsDate
		...
		'sVal = showModalDialog("AddSchedPLSubHeads.asp?sUnit="&sOrgId&"&sSchName="&sSchedName&"&sCatCode="&sCatCode,"A","dialogHeight:300px;dialogWidth:580px;center:Yes;help:No;resizable:No;status:No")
		sVal = showModalDialog("AddSchedPLSubHeads.asp?sUnit="&sOrgId&"&sSchName="&sSchedName&"&InsDate="&sInsDate,"A","dialogHeight:300px;dialogWidth:800px;center:Yes;help:No;resizable:No;status:No")
		IF CStr(sVal) = "Y" Then
