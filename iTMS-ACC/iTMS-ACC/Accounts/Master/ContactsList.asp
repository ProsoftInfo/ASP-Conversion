...
'-------------------------------------------------------------------------------------------
Function ViewContactDeatils(sContactNo)
	document.formname.action = "NewContact.asp?ContactNo="&sContactNo
	document.formname.submit
End Function
'-------------------------------------------------------------------------------------------
Function CreateNewContacts()
	document.formname.action = "NewContact.asp"
	document.formname.submit
End Function
'-------------------------------------------------------------------------------------------
...
Function CheckSubmit()
	document.formname.hParName.value = document.formname.txtContactName.value
...
Function DelContact()
	...
	Dim sRow,iCtr,sContactNoValue,objHttp
	...
	For iCtr=1 to cint(document.formname.hCnt.value)
	    ...
	    if cint(document.formname.hCnt.value)=1 then
	        if eval("document.formname.radButton").checked = true then
			    ...
			    sContactNoValue = eval("document.formname.radButton").value
			end if
		else
			if eval("document.formname.radButton")(iCtr-1).checked = true then
			    iSelItemCount = iSelItemCount + 1
			    sContactNoValue = eval("document.formname.radButton")(iCtr-1).value
			end if
	...
	Objhttp.Open "POST","ContactDeleteEntry.asp?hContactNo=" & sContactNoValue , false
	Objhttp.send
