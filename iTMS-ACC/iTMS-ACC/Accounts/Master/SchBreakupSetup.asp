...
<%	option explicit	%>
<%
	'Program Name				:	SchBreakupSetup.asp
...
<SCRIPT LANGUAGE=VBScript>
	...
	Function AddPopUp()
		Dim sOrgId,sSchedName
		Dim sVal,sCatCode,sInsDate
		sCatCode = 0
		...
		sVal = showModalDialog("AddSchedBrkSubHeads.asp?sUnit="&sOrgId&"&sSchName="&sSchedName&"&sCatCode="&sCatCode&"&InsDate="&sInsDate,"A","dialogHeight:320px;dialogWidth:710px;center:Yes;help:No;resizable:No;status:No")
		'sVal = showModalDialog("AddSchedSubHeads.asp?sUnit="&sOrgId&"&sSchName="&sSchedName&"&sCatCode="&sCatCode,"A","dialogHeight:300px;dialogWidth:580px;center:Yes;help:No;resizable:No;status:No")
		'window.open "AddSchedBrkSubHeads.asp?sUnit="&sOrgId&"&sSchName="&sSchedName&"&sCatCode="&sCatCode,"A","Height:580px;Width:930px;center:Yes;help:No;resizable:No;status:Yes"
		'window.open "AddSchedBrkSubHeads.asp?sUnit="&sOrgId&"&sSchName="&sSchedName&"&sCatCode="&sCatCode,"A"
	...
	Function DisplayVal()
		'MsgBox document.formname.selUnitId.selectedIndex
	...
	Function CheckSubmit()
		...
		IF document.formname.selSch.selectedIndex = 0 Then
			...
			Exit Function
		End IF
		document.formname.action ="SchBreakupUpdate.asp"
		document.formname.submit()
	End Function
'**************************Added By Maheshwari on 29 Sep 2006*******************************
Function popAccList(nPassCtr,nEntNo)
	Dim iUnitNo,saTemp,iGlHead,sRetVal,OutValue,sAccHeadName,sNewAcc
	document.formname.hEntNo.value = nEntNo
	'if document.formname.selUnitId.selectedIndex >0 then
		sOrgId= document.formname.hOrgID.value
		OutValue= showModalDialog("ChgAccHeadName.asp?orgId="+sOrgId,"","dialogHeight:480px;dialogWidth:520px;center:Yes;help:No;resizable:No;status:No")
		arrTemp = split(OutValue,":")
		arrTemp = split(OutValue,":")
		while UBound(arrTemp) = 0
			OutValue = showModalDialog("ChgAccHeadName.asp?"&OutValue,"","dialogHeight:480px;dialogWidth:520px;center:Yes;help:No;resizable:No;status:No")
			arrTemp = split(OutValue,":")
		wend
		sRetVal = OutValue
		'alert(sRetVal)
...
window.__itmsPopupCompat = {
	...
	page: "SchBreakupSetup.asp",
	reloadPage: "SchBreakupSetup.asp",
