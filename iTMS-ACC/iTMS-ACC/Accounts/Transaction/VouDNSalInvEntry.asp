...
Function SaveXML()
	...
	setFlag = false
'alert(document.formname.hCallFromDebit.value)	 
if trim(document.formname.hCallFromDebit.value)="DR" then
	...
	End IF	
		...
		if objhttp.responseText <> "" then
		    ...
		    document.formname.action = "VouDNSalInvUpdate.asp"
...
Function showGLHead(sOrgId)
	...
	while OutValue.getAttribute("Action")<>"Done"
		OutValue = showModalDialog("../../Common/GLHeadSelection.asp?"&sQuery,GLData,"dialogHeight:480px;dialogWidth:420px;center:Yes;help:No;resizable:No;status:No")
		if OutValue.getAttribute("Action")="CLOSE" then exit function
		sQuery = OutValue.getAttribute("PassQuery")
	wend
