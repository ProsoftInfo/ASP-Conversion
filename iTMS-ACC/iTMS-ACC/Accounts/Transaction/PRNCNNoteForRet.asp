...
%>
<%
	'Program Name				:	PRNCNNoteForRet.asp
...
'------------------------Declaration Constants -----------------------------
	...
	Dim iPartyCode,sTemp,sExp,TempNode,sPurTyFor,sPurInfo,AccVoucherNo,iEnNo
	...
	IF CStr(sPurInfo) <> "" Then
		Narration = "Being For the Purchase Inv No:"&sPurInfo&" For "&sPurTyFor&" "&sNewNarr
	Else
		Narration = "Being For the Sales Inv No:"&sSalInfo&" Returned "&sNewNarr
	End IF
	iLineNo=17
