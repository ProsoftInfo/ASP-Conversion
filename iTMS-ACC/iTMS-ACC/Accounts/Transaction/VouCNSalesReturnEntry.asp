...
<%	option explicit	%>
<%
	'Program Name				:	VouCNSalesReturnEntry.asp
...
Dim oDOMGJ,oDGjRoot,oDGjEntry,oDGjAcc,oDGjNarr,oDSubNode,nRatePer,iSalInvoiceNo,iSalReturnNo
...
'Response.Write "Sal Reutn No = "& iSalReturnNo 
'Response.End 
