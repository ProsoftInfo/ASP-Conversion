...
<!--#include virtual="/Accounts/Transaction/GeneratePurVou.asp"-->
...
sQry = "Select CreatedVoucherNo,VoucherNumber,BookNumber,Convert(Varchar,VoucherDate,103) From Acc_T_VoucherHeader Where CreatedTransNo = "&iTransNo&" "
rs1.Open sQry,Con
IF Not rs1.EOF Then
	sOldCrNo = rs1(0)
	sOldAccNo = rs1(1)
...
Response.Write iTransNo &"<br><br><br>"
...
sQry = "SELECT Distinct T.AccUnitAccountHead, T.Amount, T.TransCrDrIndication,  "&_
...
Response.Clear
'========================== Deletion is Over ============================================
CreatePurInv sOldCrNo,sOldAccNo,iOldBookNo,sOldVouDate
...
'	Response.Clear
	...
	Response.Write  "<b>DIFFERENCES IN " &sDiffIn  &"</b><br>"
	Response.End 
End IF
