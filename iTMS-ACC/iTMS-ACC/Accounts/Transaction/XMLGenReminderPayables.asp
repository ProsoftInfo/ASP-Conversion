...
%>
<%
	'Program Name				:	XMLGenReminderPayables.asp
	'Module Name				:	Accounts 
	'Modified By				:	Ragavendran
	'Modified On				:	16th Sep 2011
	'Tables Used				:
	'Temporary Tables			:
	'Temporary Files			:
	...
	IF CStr(iPartyCode) = "0" Then
		...
		Do While Not objRs2.EOF 
		    ...
		    sQuery = "Select P.AdvancePaid - isNull(P.AdvanceAdjusted,0),H.TransactionType, Convert(Char,H.VoucherDate,103),H.CrDrIndication, isNull(P.AdvanceAdjusted,0), "&_
				 "P.AdvancePaid, VoucherNumber,Convert(Char,VoucherDate,103),H.TransactionNumber "&_
			...
			sQuery = "Select PartyBillNumber,Convert(varchar,PartyBillDate,103),AmountPayable,AmountPaid,0,"&_
                 ...
                 " and partyType='"& sPartyType &"' and AmountPayable>AmountPaid "
