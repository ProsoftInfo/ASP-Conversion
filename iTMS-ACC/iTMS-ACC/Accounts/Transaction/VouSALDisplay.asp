...
<%	option explicit	%>
<%
	'Program Name				:	VouSALDisplay.asp
...
dim sSalType,sOrgId,sQuery,sPartyName,sRefernceNo,sInvDet
dim sDiscPer,dBasicTotal,dDisTotal,sBookNo
dim sTaxName,sCatCode,sTaxCode,dTax,sTaxMode,sFormula,dTaxValue
dim iTransNo,sOrgName,sBookName,sParType,sParSubType,sParCode,sOrgPartyCode
Dim sExp,CheckNode,sCallFrm,sRetVal
	...
	if oNodTemp.nodeName="Header" then
		for Each oNodEntry in  oNodTemp.childNodes
			...
			if oNodEntry.nodeName="Party" then
				...
				sParCode=oNodEntry.getAttribute("ParCode")
...
<%Else%>
	<form method="POST" name="formname" action="SALESVOUCHERENTRY.ASP">
<%End IF %>
			...
			<TABLE id=Table16 cellSpacing=0 cellPadding=0 border=0 width="100%"  >
					...
					<td height="20" valign="bottom">
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td class="TabCell" valign="bottom" align="center" width="80">
								  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="TabTable" onMouseOver="tabrollover(this)" onMouseOut="tabrollout(this)">
								  	<tr>
				...
				<TR>
                    ...
                    &nbsp;
                            ...
                            <td width="160" class="FieldCellSub"><span class="DataOnly"><%=sBookNo%>&nbsp;</span>
                            </td>
                            <td class="FieldCellSub">Book Name</td>
                            <td class="FieldCellSub" width="160"><span class="DataOnly"><%=sBookName%>&nbsp;</span>
                            </td>
                                </tr>
                                <tr>
                            ...
                            <td width="160" class="FieldCellSub"><span class="DataOnly"><%=sRefernceNo%>&nbsp;</span>
                            </td>
                            <td class="FieldCellSub">
                            <p align="left"></td>
                            <td class="FieldCellSub" width="160">
                ...
                <td></td>
                <td valign="top" width="100%">
                <div class="frmBody" id="frm2" style="width: 580; height:242;">
...
dim dInvAmount
	...
	For Each oNodEntry in oNodTaxRoot.childNodes
		...
		IF CStr(oNodEntry.Attributes.Item(6).nodeValue) <> "0" Then
			%>
			<tr>
	...
	dInvAmount=oNodTaxRoot.Attributes.GetNamedItem("NettValue").value
%>
    ...
    <td class="ExcelSerial" align="right"> <%=FormatNumber(dInvAmount,2,,,0)%> </td>
                ...
                <td></td>
                            ...
                            <td>
                                                               <span class="DataOnly"><%=AmountWords(FormatNumber(dInvAmount,2,,,0))%></span>
                            </td>
                                    </table>
