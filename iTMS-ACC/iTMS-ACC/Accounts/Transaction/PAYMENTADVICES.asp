...
Function CheckFromDate()
	...
	if sYear&sMonth < Left(sPeriod,4)&"03" or sYear&sMonth >Right(sPeriod,4)&"04" then
		MsgBox "From Date must be Between "& sFrmYr  &" and "&sToYr,64,"Payment Advice"
...
Function CheckToDate()
	...
	sToYr = "31/03/"&sTemp(1)
	if sYear&sMonth < Left(sPeriod,4)&"03" or sYear&sMonth >Right(sPeriod,4)&"04" then
		MsgBox "To Date must be Between "& sFrmYr  &" and "&sToYr,64,"Payment Advice"
...
Dim sFromDate,sToDate,objhttp,Root
	...
	if document.formname.selBook.value="S" Then
		Msgbox "Select Book",64,"Payment Advice"
		document.formname.selBook.focus
		document.formname.SelAccHead.selectedIndex=0
		Exit Function
	end if
...
End Function
	...
	Function ShowVouch(iCrTransNo)
		...
		showModalDialog "PaymentAdviceDis.asp?Value="&iCrTransNo,"","dialogHeight:600px;dialogWidth:750px;center:Yes;help:No;resizable:No;status:No"
		Exit Function
	End Function
