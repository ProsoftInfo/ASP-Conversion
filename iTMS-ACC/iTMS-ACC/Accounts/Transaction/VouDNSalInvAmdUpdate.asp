...
<%	option explicit	%>
<%
	'Program Name				:	VouDNSalInvAmdUpdate.asp
...
dim dAdjAmtTotal,objfs,iItemCode,iClassCode
...
sQuery=sQuery&",'Sales ADD ','SI','"&sVouType&"',"&getUserid&",getdate(),NULL,'"&sVouStatus&"', "&ActualTransNo&",'"&sDispType&"')"
...
'	Response.End 
	...
	Response.Redirect ("VouDNSalInvDisplay.asp?TransNo="&iCrTransNo&"&CallFrm=E")
