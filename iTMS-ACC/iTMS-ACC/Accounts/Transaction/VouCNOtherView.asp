...
<%	option explicit	%>
<%
	'Program Name				:	VouCNOtherView.asp
...
<form method="POST" name="formname" action="VouCNBookSelection.asp">
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													<tr>
														<td valign="middle" class="ActionCell">
															<p align="center">
                                                                <input type="submit" value="Done" name="B7" class="ActionButtonX" >
