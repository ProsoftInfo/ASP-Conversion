...
<%	option explicit	%>
<%
	'Program Name				:	VouCNOtherInvDisplay.asp
...
dim sTaxName,dTax,sTaxMode,dTaxValue,iTransNo,sRate,sDisAmt,sUOM

dim sOrgName,sBookCode,sBookName,sPartyName,sInvoiceNo

dim sVouNo,sVouDate,sRetVal
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td align="center" class=PageTitle height="20"><p align="center">Credit Note For Other Invoices 		</td>
    </tr>
	<tr>
    ...
    <td class="ExcelHeaderCell" align="center" width="75">Rate</td>
    <td class="ExcelHeaderCell" align="center" width="75">Discount Amount</td>
...
iSno=0
	...
	For Each oNodEntry in oNodDeatils.childNodes
		...
		sDisAmt = oNodEntry.Attributes.Item(8).nodeValue
		sUOM = oNodEntry.Attributes.Item(4).nodeValue


		if CDbl(sAmount)> 0 then
			dTotal=CDbl(dTotal)+CDbl(sAmount)
			'Response.Write dTotal &"<br>"
			iSno=cint(iSno)
...
%>
    ...
    <td class="ExcelDisplayCell" align="Right" width="75"><%=FormatNumber(sQty,3,,,0)%>&nbsp;<%=sUOM%></td>
    <td class="ExcelDisplayCell" align="Right" width="75"><%=FormatNumber(sRate,2,,,0)%></td>
    <td class="ExcelDisplayCell" align="Right" width="75"><%=FormatNumber(sDisAmt,2,,,0)%></td>
...
dim dInvAmount
	...
	For Each oNodEntry in oNodTaxRoot.childNodes
		IF oNodEntry.nodeName = "Tax" Then
...
%>
        ...
        <tr>
        <td align="center"></td>
    <td class="ExcelSerial" align="right" colspan="4"><b>Credit Note Value&nbsp; </b></td>
													...
													<tr>
														<td valign="middle" class="ActionCell">
                                                            <p align="center">
                                                                ...
                                                                <!-- This is For LMC Only -->
                                                                <!--input type="button" value="Print" name="B8" onClick="PrintWindow('PRNCreditNote.asp?iTraNo=<%=iTransNo%>')" class="ActionButton"-->
                                                                <!-- This is For SANGEETH Only -->
                                                                <input type="button" value="Print" name="B8" onClick="PrintWindow('PRNCNDNOthInv.asp?iTransNo=<%=iTransNo%>')" class="ActionButton">
														</td>
													</tr>
												</table>
								</td>
