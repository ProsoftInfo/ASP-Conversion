	...
	if 	document.formname.SelAccHead.value="G" then
		...
		If  OutValue.hasChildNodes Then
			...
			if AccHeadNode.Length > 0 then
				...
				'	document.formname.hAccHead.value = document.formname.hAccHead.value & "," &AccHeadNode.Item(itr).Attributes.getNamedItem("AccHeadCode").value
				'	document.formname.txtAccHead.value= document.formname.txtAccHead.value & "," &AccHeadNode.Item(itr).Attributes.getNamedItem("AccHeadName").Value
...
Function SetDate()
	...
	Call DisplayBook()
'alert(document.formname.selBook.length)
'alert(document.formname.hBookNo.value)
'alert(document.formname.haccIndex.value)
...
Function GetFormDet()
	...
	sFormVal = sFormVal&"|"&document.formname.selBook(document.formname.selBook.selectedIndex).value
	...
	if Trim(document.formname.hAccIndex.value)="" then
		sFormVal = sFormVal&"|"&""
	else
...
Function PrintWindow()
	sPassStr = trim(document.formname.hUnitNo.value)& "|" & document.formname.hUnitName.value &"|"& " " & "|"&Trim(document.formname.hBookVal.value)&"|"& "VouDate"& "|"&document.formname.hFromDate.value& "|"& document.formname.hToDate.value & "|" & "B"
	showModalDialog "../Reports/PRNDBCashStmentView.asp?Value="&sPassStr,"A","dialogHeight:150px;dialogWidth:300px;center:Yes;help:No;resizable:No;status:No"
End Function
</script>
</head>
