...
dim sAccHeadCode,dTdsAmt,dTdsPer,CheckNode
...
oDOM.Load server.MapPath("../temp/transaction/Voucher AMD_CN_"&Session.SessionID&".xml")
...
if con.Errors.count <>0 then
	...
	if objfs.FileExists(server.MapPath("../temp/transaction/Voucher AMD_CN_"&Session.SessionID&".xml")) then
	    objfs.DeleteFile(server.MapPath("../temp/transaction/Voucher AMD_CN_"&Session.SessionID&".xml"))
	end if'if objfs.FileExists(server.MapPath("../temp/transaction/Voucher AMD_CN_"&Session.SessionID&".xml")) then
	Response.Redirect ("VouCNOtherDisplay.asp?TransNo="&iTransNo)
end if
