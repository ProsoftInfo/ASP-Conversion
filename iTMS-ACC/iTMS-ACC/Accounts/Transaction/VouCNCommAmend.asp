...
<XML id="EntryData"><Entry No="0" CRDR="0" Payto="" Amount="" AccUnit="" AccName="" TdsAmount="" TDSElgi="0" TdsPercentage="0" />
</XML>
...
dim iCode,dRatio,dAmount,TempNode,sExp,CheckNode,sNarrChk
bVouFlag = true
bflag = sVal
sNarrChk = "N"
...
if bVouFlag then
	...
	EntryRoot.Attributes.getNamedItem("CRDR").Value="D"
...
dim dTotal,sAccUnit,dTdsAmt,sTdsPer,sExp,CheckNode
set VouRoot=VoucherData.documentElement
'alert VouRoot.xml
...
For Each EntryNode in VouRoot.childNodes
	...
	InsertCell oRow,1,"",dTdsAmt,"ExcelDisplayCell","left","top",0,0,0,0,""
...
Function SaveXML()
	...
	objhttp.Open "POST","XMLSave.asp?Mod=CN&Name=Voucher AMD", false
...
Function clearXML()
	...
	EntryRoot.setAttribute "TDSElgi",""
