...
<%	option explicit	%>
<%
	'Program Name				:	OrgUnitDefinitionEntry.asp
...
<XML ID="DivData" src="../xmldata/Division.xml"></XML>
<SCRIPT LANGUAGE=javascript SRC="../../scripts/rolloverout.js"></SCRIPT>
<SCRIPT LANGUAGE=javascript SRC="../scripts/orgUnitDefinition.js"></SCRIPT>
...
function DisplayOrgDet() {
	if (document.forms[0].selOrgUnit.selectedIndex == "1") {
		document.forms[0].reset();
		document.forms[0].selOrgUnit.selectedIndex = 1;
		document.forms[0].selParOrgUnit.disabled = true;
		recParent=orgData.recordset;
		recParent.moveFirst();
		while (!recParent.EOF) {
			document.formname.txtUnitAddr1.value=recParent.fields(5).value;
			document.formname.txtUnitAddr2.value=recParent.fields(6).value;
			document.formname.txtUnitPIN.value=recParent.fields(7).value;
			document.formname.txtUnitCity.value=recParent.fields(8).value;
			document.formname.txtUnitState.value=recParent.fields(9).value;
			document.formname.selUnitCountry.length = 0;
			document.formname.selUnitCountry.length = document.formname.selUnitCountry.length+1;
			document.formname.selUnitCountry.options[document.formname.selUnitCountry.length-1].text = recParent.fields(11).value;
			document.formname.selUnitCountry.options[document.formname.selUnitCountry.length-1].value = recParent.fields(10).value;
			document.formname.txtUnitPhone.value=recParent.fields(12).value;
			document.formname.txtUnitFax.value=recParent.fields(13).value;
			document.formname.txtUnitEmail.value=recParent.fields(14).value;
			document.formname.txtUnitURL.value=recParent.fields(15).value;
			document.formname.txtUnitContactPerson.value=recParent.fields(16).value;
			document.formname.txtUnitTNGSTNo.value=recParent.fields(17).value;
			document.formname.txtUnitCSTRCNo.value=recParent.fields(18).value;
			document.formname.UnitCSTRCDate.setDate = recParent.fields(19).value;
			//document.formname.txtUnitCSTRCDate.value=recParent.fields(19).value;
			document.formname.txtUnitAreaCode.value=recParent.fields(20).value;
			recParent.moveNext();
		}
	}
	else {
		if(document.forms[0].selOrgUnit.selectedIndex == "2") {
			document.forms[0].reset();
			document.forms[0].selOrgUnit.selectedIndex = 2;
			document.forms[0].selParOrgUnit.disabled = false;
		}
		else {
			document.forms[0].reset();
			document.forms[0].selParOrgUnit.disabled = false;
...
function DisplayDivDet(objDiv) {
	if(!document.forms[0].selOrgUnit.selectedIndex == "0") {
		var iDivId,recParent;
		iDivId=objDiv[objDiv.selectedIndex].value
		recParent=DivData.recordset;
		recParent.moveFirst();
		while (!recParent.EOF) {
			if (recParent.fields(0).value==iDivId) {
				document.formname.txtUnitAddr1.value=recParent.fields(4).value;
				document.formname.txtUnitAddr2.value=recParent.fields(5).value;
				document.formname.txtUnitPIN.value=recParent.fields(6).value;
				document.formname.txtUnitCity.value=recParent.fields(7).value;
				document.formname.txtUnitState.value=recParent.fields(8).value;
				document.formname.selUnitCountry.length = 0;
				document.formname.selUnitCountry.length = document.formname.selUnitCountry.length+1;
				document.formname.selUnitCountry.options[document.formname.selUnitCountry.length-1].text = recParent.fields(10).value;
				document.formname.selUnitCountry.options[document.formname.selUnitCountry.length-1].value = recParent.fields(9).value;
				document.formname.txtUnitPhone.value=recParent.fields(11).value;
				document.formname.txtUnitFax.value=recParent.fields(12).value;
				document.formname.txtUnitEmail.value=recParent.fields(13).value;
				document.formname.txtUnitURL.value=recParent.fields(14).value;
				document.formname.txtUnitContactPerson.value=recParent.fields(15).value;
				document.formname.txtUnitTNGSTNo.value=recParent.fields(16).value;
				document.formname.txtUnitCSTRCNo.value=recParent.fields(17).value;
				document.formname.UnitCSTRCDate.setDate = recParent.fields(18).value;
				//document.formname.txtUnitCSTRCDate.value=recParent.fields(18).value;
				document.formname.txtUnitAreaCode.value=recParent.fields(19).value;
				document.formname.txtUnitRange.value=recParent.fields(20).value;
				document.formname.txtUnitDivision.value=recParent.fields(21).value;
				document.formname.txtUnitCollectorate.value=recParent.fields(22).value;
				document.formname.txtUnitCentralENo.value=recParent.fields(23).value;
				document.formname.txtUnitRegNo.value=recParent.fields(24).value;
				document.formname.txtUnitLANo.value=recParent.fields(25).value;
				document.formname.txtRangeAdd1.value=recParent.fields(26).value;
				document.formname.txtRangeAdd2.value=recParent.fields(27).value;
				document.formname.txtRangeAdd3.value=recParent.fields(28).value;
				document.formname.txtDivisionAdd1.value=recParent.fields(29).value;
				document.formname.txtDivisionAdd2.value=recParent.fields(30).value;
				document.formname.txtDivisionAdd3.value=recParent.fields(31).value;
			}
			recParent.moveNext();
		}
	}
					...
					<td height="20" valign="bottom">
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
							<tr>
								...
								<td class="TabCurrentCell" valign="bottom" align="center" width="190">
								  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="TabCurrentTable">
								   <tr>
									  <td width="100%" align="center">Organization Units Definition</td>
									</tr>
								  </table>
								</td>
														...
														<td>
															<table cellpadding="0" cellspacing="0" width="100%">
																...
																<tr>
																	...
																	<td class='FieldCell'>
																	<select size="1" name="selOrgUnit" onChange="DisplayOrgDet()" class="FormElem">
																...
																<tr>
																	<td class=FieldCell width="151"> Parent Organization Unit </td>
																	<td class='FieldCell'>
																	<select size="1" name="selParOrgUnit" onChange="DisplayDivDet(this)" class="FormElem">
																		<option value="select">Select</option>
																	<%	'Calling the Function which populates the Organization Units Definition list
																		populateOrganizationUnitDefinition
																	%>
																	</select>
														            </td>
																</tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													<tr>
														<td valign="middle" class="ActionCell">
															<p align="center">
                                                                <input type="button" value="Save" name="B2" class="ActionButton" tabindex="3" onClick="javascript:checkSubmit('<%=FormatDate(now)%>')">
