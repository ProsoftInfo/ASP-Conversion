...
<%	option explicit	%>
<%
	'Program Name				:	MtnNoSeriesEntry.asp
	'Module Name				:
	'Author Name				:
	'Modified By				:
	'Created On					:
	...
	'Input Parameter			:
	'							:
	'Connects To				:	MtnNoSeriesInsert.asp
...
<%
	...
	Do While Not Objrs.EOF
		...
		sQuery = "Select EntryNo,Period,Number,isNull(Prefix,''),isNull(Suffix,'') From "&_
		...
		Do While Not Objrs2.EOF
			...
			EntryNode.setAttribute "Period", Objrs2(1)
			EntryNode.setAttribute "Number", Objrs2(2)
			EntryNode.setAttribute "Prefix", Objrs2(3)
			EntryNode.setAttribute "Suffix", Objrs2(4)
...
<SCRIPT LANGUAGE=javascript SRC="../scripts/MtnNoSeriesEntryCompat.js"></SCRIPT>
</HEAD>
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" onLoad="popSeriesNo()" MARGINWIDTH="0">

<form method="POST" name="formname" action="MtnNoSeriesInsert.asp">
...
<input type=hidden name="hWorkGroupValue" value="">
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
								...
								<td valign="top" width="100%">
									...
									<tr>
											...
											<td class="FieldCellSub">
											    <select size="1" name="selActType" class="FormElem" onchange="FormReset();document.formname.selUnit.selectedIndex = 0">
										...
										<tr>
											<td class=FieldCell>Work Group </td>
											<td class="FieldCellSub">
												<INPUT type="radio" name="OptWorkGroup" value = "A" onClick="PopupDet(this)" checked> All
												<INPUT type="radio" name="OptWorkGroup" value = "S" onClick="PopupDet(this)"> Specific
												&nbsp;
												<Span id="SpnWorkGroup" class="DataOnly" ></span>
												</Select>
											</td>
										</tr>
												...
												<table border="0" cellpadding="0" cellspacing="0" width="100%">
													<tr>
														<td valign="middle" class="ActionCell">
															...
															<input type="button" value="Cancel" name="btnCancel" class="ActionButton" onClick="Cancel('../welcome_Maintenance.asp')">
							...
							<DIV class=frmBody id="DisVoucher" style="width:500; visibility:hidden; height:1;">
								...
								<tr>
									...
									<td align="center" class="ExcelHeaderCell" width="100">Work Group</td>
									<td align="center" class="ExcelHeaderCell" width="100">Work Group Desc</td>
