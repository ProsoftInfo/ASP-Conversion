...
%>
<%
	'Program Name				:	clsClassDataListItemSingle.asp
	'Module Name				:
	'Author Name				:	MOHAMMED ASIF
	'Created On					:	March 16, 2004
	'Modified By				:	SRIDEVI PRIYA A.
	'Modified On				:
	'Tables Used				:
	'Temporary Tables			:
	'Temporary Files			:
...
' ------------------------------------------------------------------------------
	Public Sub AddReturnedField(ByRef psCaption)
		...
		'Response.Write mnReturnFieldCount
		'Response.End
...
' ------------------------------------------------------------------------------
	Private Function GetHeader()
		...
		If Not PrimaryKey = "" Then
			lsHTML = lsHTML & "<TD align=""center"" width=""5"">Select</TD>"
		End If
			...
			If Not PrimaryKey = "" Then
				...
				If lnRowIndex <= lnRowCount Then
					...
					lsHTML = lsHTML & "<INPUT" & _
						...
						" class=""FormElem""" & _
						" name=""pKey""" & _						
						" value=""" & replace(lvPrimaryValue,"""","~~") & """"
						
						'" value=""" & lvPrimaryValue & """"
						
						
					''checked has been removed so that no item is selected on load of the page
					If lnRowIndex = 0 Then lsHTML = lsHTML & " "
