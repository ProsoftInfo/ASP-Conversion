...
' ------------------------------------------------------------------------------
	Private Function GetFooter()
		...
		'Response.Write "<p><font color=red>mnLastPage="&mnLastPage
		If mnLastPage >= 2 Then
			...
			lsHTML = lsHTML & "&nbsp;"
			lsHTML = lsHTML & "<INPUT TYPE=BUTTON VALUE=""Add New"" ONCLICK=""sendNewValue()"" class=""ActionButton"" id=BUTTON2 name=BUTTON2>"
			lsHTML = lsHTML & "</TD>"
			lsHTML = lsHTML & "</TR>"
		...
		Elseif mnLastPage = -1 Then	'Added By UmaMaheswari S, on 30th June 2011
		...
		lsHTML = lsHTML & "<TD colspan=""" & lnColSpan & """>"
		lsHTML = lsHTML & "Party Name <INPUT type=""text"" class=""FormElem"" name=""Query"" value=""" & Server.HTMLEncode(msQuery) & """ size=""20"">"
