...
%>
<%
	'Program Name				:	mrsSTSchedulePoP.asp
	'Module Name				:	Inventory (MRS ST Schedule)
...
<HTML><HEAD><TITLE>iTMS - Stock Transfer Schedule Details</TITLE>
...
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="fnInit('<%=iItem%>','<%=iClass%>','<%=iQty%>','<%=iEntNo%>','STSchedule')">
...
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="PopUpTable">
	...
	<tr>
		<td align="center" class=PageTitle height="20"><p align="center">Stock Transfer - Schedule
		</td>
    </tr>
	<tr>
		<td align="center" class="TopPack">
