...
%>
<%
	'Program Name				:	ItemMergeBagSelPop.asp
										...
										'Response.Write "<p><font color=red>"&sQuery
											...
											if not dcrs2.EOF then
												...
												For iPageCtr = 1 to dcrs2.PageSize
													...
													Response.Write "<font color=#000000>"
													sAttrbName=""
													If trim(iAttrbList) <> "0" and trim(iAttrbList)<>"" and trim(iAttrbList)<>"NULL" then
													    iAttrbList = split(iAttrbList,":")(0)
										...
										%>
											...
											<tr>
												...
												<td class="ExcelDisplayCell" >
													<input type="text" name="txtSerial<%=iCtr%>"  value="<%=trim(dcrs2(2))%>" maxlength=10 class="FormElemRead" READONLY>
													<input type="hidden" name="hSerial<%=iCtr%>" value="<%=trim(dcrs2(0))%>">
													<input type="hidden" name="hInvNoZ<%=iCtr%>" value="<%=trim(dcrs2(4))%>">
												</td>
												<td class="ExcelDisplayCell" >
													<input type="text" name="txtAttrb<%=iCtr%>" size="25" maxlength=20  value="<%=sAttrbName%>" class="FormElemRead" READONLY style="text-align:right">
												</td>
												<td class="ExcelDisplayCell">
													<input type="text" name="txtStQty<%=iCtr%>" size="16" maxlength=10 value="<%=cdbl(trim(dcrs2(1)))%>" class="FormElemRead" READONLY style="text-align:right">
												</td>
