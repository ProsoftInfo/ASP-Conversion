...
'---------------------------------------------
Function ReturnData()
    set obj = document.formname.chkReqType
    if obj.checked = true then
        divItemData.style.display="block"
    else
        divItemData.style.display="none"
    end if
    RetItemData()
End Function
'----------------------------------------------
...
Function GetAddDet(iClass,iItem,sOrgid,iEntNo)
    ...
    if trim(sType)="SUB" then
		    sTempValues = iClass&"|"&iItem&"|"&sOrgid&"|"&sUsage&"|"&trim(Q.value)&"|"&sItemMode

	        set OutValue = showModalDialog("IssSubConProcessDetailsPop.asp?sTemp="&sTempValues,OutData2,"dialogHeight:370px;dialogWidth:500px;center:Yes;help:No;resizable:No;status:No")
            'alert(OutValue.xml)
    else
	...
	if root.hasChildNodes then
		...
		if CheckNode.Length > 0 then
			...
			For iCounter = 0 to CheckNode.Length - 1
				...
				'Requested
				set headerCell=oRow.insertCell()
				set oText = document.createElement("<input type=""text"" name=""txtRequestedZ"&CStr(iItem)&"Z"&CStr(iClass)&"Z"&CStr(iEntNo)&""" Value="""&iRequested&""" size=""5"" class=""FormElemRead"" style=""text-align=right;cursor:hand;FONT-WEIGHT: bold"" alt=""In Unit Stock Details"" READONLY>")
				headerCell.appendChild(oText)
				headerCell.width = "10"
				headerCell.className="ExcelDisplayCell"
				...
				'In Unit
				set headerCell=oRow.insertCell()
				set oText = document.createElement("<input type=""text"" name=""txtStockZ"&CStr(iItem)&"Z"&CStr(iClass)&"Z"&CStr(iEntNo)&""" Value="""&iStock&""" size=""5"" class=""FormElemRead"" style=""text-align=right;cursor:hand;FONT-WEIGHT: bold"" alt=""In Unit Stock Details"" READONLY onkeypress=""DisplayStock(this)"">")
				headerCell.appendChild(oText)
				headerCell.width = "10"
				headerCell.className="ExcelDisplayCell"
				headerCell.align="right"
				...
				headerCell.innerHtml = headerCell.innerHtml + "<input type=""text"" name=""txtQtyPPX"&CStr(iClass)&"X"&CStr(iItem)&"X"&CStr(iEntNo)&""" size=""10"" class=""FormElem"" onkeypress=""DoKeyPress('',7,3)"" style=""text-align:right"" onBlur=""GetSch(this)"">"
				...
				set oText = document.createElement("<input type=""text"" name=""txtToIssueZ"&CStr(iItem)&"Z"&CStr(iClass)&"Z"&CStr(iEntNo)&""" Value="""&iToIssue&""" size=""5"" class=""FormElemRead"" style=""text-align=right;cursor:hand;FONT-WEIGHT: bold"" alt=""In Unit Stock Details"" READONLY>")
				headerCell.appendChild(oText)
				headerCell.width = "10"
				headerCell.className="ExcelDisplayCell"
				headerCell.align="right"
							...
							<tr>
								<td align="center" colspan="3" class="BottomPack"></td>
                                        ...
                                        <tr>
											...
											<td class="FieldCellSub">
											    <table>
											        <tr>
											             <td class="FieldCell">
											                 <input type="checkbox" name="chkReqType" class="FormElem" value="Returnable" onclick="ReturnData()">Returnable Item
											            </td>
											            <td class="FieldCell">
											                <div id="divItemData" style="display:none;">
												                <input type="radio" name="radItem" value="S" onclick="RetItemData()" checked>Same
												                <input type="radio" name="radItem" value="D" onclick="RetItemData()" >Diff.
												            </div>  
											            </td>
											        </tr>
											    </table>
										...
										<tr>
										    ...
										    <td class="FieldCellSub">
										    <textarea name="Remarks" cols="50" class="Formelem" maxlength="100"></textarea>
																...
																<DIV class=frmBody id=frm2 style="height:230;">
																	<table  id="tblLot" border="0" cellspacing="1" class="ExcelTable" width="100%">
																		<tr>
																			...
																			<td class="ExcelHeaderCell" align="center" rowspan="3">
...
<!--																			<a href="#"><img border="0" src="../../assets/images/iTMS%20Icons/EntryIcon.gif" align="center" alt="Click here to Select Item (s)" width="11" height="11" onClick="GetItems('<%=FormatDate(date)%>')"></a>-->
																			...
																			<td class="ExcelHeaderCell" align="center" colspan="4">Quantity Availability</td>
																	    ...
																	    <tr>
																	        <td class="ExcelHeaderCell" align="center">Requested</td>
																		...
																		<tr>
																		    <td class="ExcelHeaderCell" align="center">To Issue</td>
