...
dim arrTemp,sOrgID,sOrgName,iQty,arrUoM,sUoMCode,sUoM,iIssNo
...
iIssNo = arrTemp(7)
'Response.write "iAttributeList = "&iAttribList
If iAttribList <> "" and trim(iAttribList)<>"NULL" then
...
<script LANGUAGE=javascript SRC="../scripts/MatConAddDetails.js"></SCRIPT>
<script LANGUAGE=javascript SRC="../../scripts/ValidateFormat.js"></SCRIPT>
</head>
<BODY leftMargin=0 topMargin=0 onLoad="fnInit('<%=sOrgID%>','<%=iClass%>','<%=iItem%>','<%=sUsage%>','<%=iIssNo%>')">
<form method="POST" name="formname" action="">
<table border="0" width="100%" cellspacing="0" cellpadding="0" class="PopUpTable">
	<tr><td height="1px"></td></tr>
	<tr>
		<td class="PageTitle">Additional Details
		</td>
    </tr>
	<tr>
