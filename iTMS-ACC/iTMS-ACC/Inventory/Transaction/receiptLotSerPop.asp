...
%>
<%
	'Program Name				:	ReceiptLotSerPop.asp
...
<%
	...
	response.write "<p>UBOUND(arrTEMP)="& uBound(arrTemp)
	sType	= arrTemp(0)
	iItem	= arrTemp(1)
	iClass	= arrTemp(2)
	sOrgID	= arrTemp(3)
...
<script LANGUAGE=javascript SRC="../scripts/ReceiptLot.js"></SCRIPT>
<script LANGUAGE=javascript SRC="../../scripts/ValidateFormat.js"></SCRIPT>
</head>
<BODY leftMargin=0 topMargin=0 MARGINHEIGHT="0" MARGINWIDTH="0" onLoad="LoadDetails('<%=trim(Request.QueryString("sTemp"))%>')">
<%	if sPackNoFlag = "" then %>
									...
									<div class="frmBody" id="frm2" style="width: 100%; height:200;">
										<table border="0" cellspacing="1" id="tblLot" class="ExcelTable" width="100%">
											...
											<tr>
												...
												<td class="ExcelHeaderCell" align="center" colspan="3">Received</td>
