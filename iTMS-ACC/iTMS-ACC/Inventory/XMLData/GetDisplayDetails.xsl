<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
	<xsl:template match="menu">
		<div class="FieldCell">
			<img src="../../assets/images/home.gif" border="0" />
			<xsl:text>&#160;</xsl:text>
			<a href="#">
				...
				<td>
					<xsl:choose>
						<xsl:when test="$hasChild='true'">
							...
							<div class="FieldCell" onclick="toggle('{$myId}','{$icon1}','{$icon2}','{$prefix}')">
						...
						<xsl:otherwise>
							...
							<div class="FieldCell" onclick="show('{concat(@caption,' - ',@action)}')">
								<img src="../../assets/images/{$prefix}.png" border="0" align="absMiddle" />
								<img src="../../assets/images/file.gif" border="0" align="absMiddle" />
								<xsl:text>&#160;</xsl:text>
								<a href="##">
									<xsl:value-of select="@caption" />
								</a>
