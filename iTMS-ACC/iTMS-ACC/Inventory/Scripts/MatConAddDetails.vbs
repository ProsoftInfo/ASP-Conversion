...
dim iClass,iItem,sUsage,sOrgID,iIssNo
j = 0
iTotQty = 0

Set Root = Data.documentElement

Function fnInit(sOrg,sClass,sItm,sUsag,sIssNo)
	...
	iIssNo= sIssNo
	'alert RootO.Xml
	sExp11 ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter"
	Set WCNode1 = RootO.Selectnodes(sExp11)
	For iwcCtr = 0 To WCNode1.Length - 1
		sExp12 ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter[@WCODE="""&WCNode1.Item(iwcCtr).Attributes.getNamedItem("WCODE").Value&"""]/MachineCenter"
...
Function GetWC(obj)
	if sUsage <> "MAT" then exit function
...
Function CheckEntry()
	...
	elseif document.formname.selWC.selectedIndex = "0" then
		...
		document.formname.selWC.focus()
		exit Function
	elseif document.formname.selMC.selectedIndex = "0" and document.formname.selMC.length > 1 then
	...
	'alert("A="&RootO.xml)
		sExp4 ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter/MachineCenter"
		...
		sEx ="//ItemDet [ @Class= "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &" ]/AddDet"
		Set ADNode = RootO.Selectnodes(sEx)
		
		sExp ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter"
		Set WCNode = RootO.Selectnodes(sExp)

		sExp1 ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]"
		Set HeaderNode = RootO.Selectnodes(sExp1)
		'alert WCNode.Length
		if WCNode.Length > 0 then
			sExp2 ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter [ @WCODE = '"&sWCCode&"']"
			...
			sExp3 ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter [ @WCODE = '"&sWCCode&"']/MachineCenter [ @MCODE = '"&document.formname.selMC.value&"']"
...
Function DeleteEntry()
	...
	If WCNode.Length > 0 Then
		For iWctr = 0 To WCNode.Length - 1
			...
			sExp ="//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet/WorkCenter[ @WCODE="""&sWCDel&"""]/MachineCenter"
				...
				for itr = 0 to MCNode.Length - 1
					...
					if objSel.checked then 'DeleteItem objSel,objSer.value + 2
						...
						If Not WCNode.Item(iWctr).HasChildNodes then
							...
							sExp = "//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&" and @IssEntryNo="& iIssNo &"]/AddDet"
							...
							If Not AddDetNode.Item(0).HasChildNodes Then
								'Remove AddDet node
								sExp = "//ItemDet [ @Class = "&iClass&" and @Item = "&iItem&"]"
