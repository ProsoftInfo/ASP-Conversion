...
Function fnInit(sOrg,sClass,sItm,sUsag)
	...
	For iwcCtr = 0 To WCNode1.Length - 1
		'sExp12 ="//ITEMDETAILS [ @CLASSCODE = "&iClass&" and @ITEMCODE = "&iItem&"]/AddDet/WorkCenter[@WCODE="""&WCNode1.Item(iwcCtr).Attributes.getNamedItem("WCODE").Value&""" and @SRL="""&iwcCtr+1&"""]/MachineCenter"
