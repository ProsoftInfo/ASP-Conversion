...
%>
<%
	'Program Name				:	ItemListEntry.asp
															...
															<table class="CollapseBand" cellspacing="0" cellpadding="0">
																<tr>
																	...
																	<td valign="center" class="SubTitle">&nbsp;&nbsp;
																	    <%
																	        if trim(sACTN)="A" then
															            %>
															                <input type="radio" name="radCap" value="C" <%if trim(sCap)="C" then response.write "Checked" %> onclick="Search()" />Capitalised
															                <input type="radio" name="radCap" value="N" <%if trim(sCap)="N" then response.write "Checked" %> onclick="Search()" />Non-Capitalise
															            <%
																	        end if
																	    %>
																	</td>
																		...
																		<table border=0 cellpadding="0" cellspacing="0" width="100%" class=BodyTable>
																			...
																			<tr>
																				...
																				<td class="FieldCellSub" colspan="3">
																			        <input type="button" value="Go" name="Cmdgo" class="ActionButton" onclick="Search()">
										...
										<td valign="top">
											...
											<table id="tblItem" border="0" cellspacing="1" class="ExcelTable" width="100%">
												...
												<%
													...
													if trim(sCap)="N" then
													    sSql = sSql & " and StockNonStock = 'S'"
													elseif trim(sCap)="C" then
													    sSql = sSql & " and StockNonStock = 'N'"
													end if
												...
												<tr>
													...
													<td class="<%=sClass%>" align="left" ><%=trim(dcrs(5))%></td>
