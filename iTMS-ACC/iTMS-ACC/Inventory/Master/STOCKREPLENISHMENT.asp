...
%>
<%
	'Program Name				:	StockReplenishment.asp
								...
								<table border="0" cellpadding="0" cellspacing="0" width="100%">
						            ...
						            <tr>
								        ...
								        <td valign="top" width="100%" align="left">
                                            <table border="0" cellpadding="0" cellspacing="0" width=100%>
                                                <tr>
											        <td>
												        <DIV class=frmBody style="width: 100%; height:390;">
													        <table border="0" cellspacing="1" class="ExcelTable" width="100%">
														        <tr>
															        <td class="ExcelHeaderCell" align="center" width="30" rowspan=2>S.No.</td>
															        <td class="ExcelHeaderCell" align="center" colspan=2>Item</td>
															        <td class="ExcelHeaderCell" align="center" colspan=2>Available</td>
															        <td class="ExcelHeaderCell" align="center" colspan=2>Reorder</td>
															        <td class="ExcelHeaderCell" align="center" rowspan=2>Economic<br>Order Qty</td>
														        </tr>
														        <tr>
															        <td class="ExcelHeaderCell" align="center">Code</td>
															        ...
															        <td class="ExcelHeaderCell" align="center">Level</td>
															        <td class="ExcelHeaderCell" align="center">Qty</td>
														        </tr>
														    <%
														        sSql = " Select YS.ItemCode,IM.ItemDescription,YS.YearClosingStock,YS.YearClosingValue,"&_
												                       " IM.ReOrderLevel,IM.ReorderQty,IM.EcoOrderQty "&_
												                       " From Inv_T_ItemYearlyStock YS,Inv_M_ItemMaster IM "&_
												                       " where YS.ItemCode = IM.ItemCode and YS.CLASSIFICATIONCODE = IM.CLASSIFICATIONCODE "&_
											                           " and YS.YearClosingStock > 0 and Convert(DateTime,YS.FinancialYearFrom,103) = "&_
												                       " Convert(Datetime,'"& dFrmDate &"',103) and YS.YearClosingStock <= IM.ReOrderLevel "
											                    If Trim(iItemCode) <> "" and Trim(iItemCode) <> "0" Then
												                    sSql = sSql & " and YS.ItemCode IN (" & iItemCode & ") "
											                    End IF

										                    	If iClass <> "" and iClass <> "0" Then
										                    		sSql = sSql & " and YS.ClassificationCode IN(" & iClass & ")  "
										                    	End IF
										                    	if trim(sItemType)<>"" then
										                    	    sSql = sSql & " and ItemTypeID='"& sItemType &"'"
										                    	end if

											                    sSql = sSql & " Order by YS.ItemCode "
											                    ...
											                    If not dcrs.EOF then
   												                    ...
   												                    Do while Not dcrs.EOF and iCtr <= dcrs.PageSize
   													                    ...
   													                    <tr>
   														                    ...
   														                    <td class="ExcelDisplayCell" align="center"><%=Trim(dcrs(0))%></td>
   														                    <td class="ExcelDisplayCell" align="Left"><%=Trim(dcrs(1))%></td>
   														                    <td class="ExcelDisplayCell" align="Right"><%=FormatNumber(Trim(dcrs(2)),2,,,0)%></td>
   														                    <td class="ExcelDisplayCell" align="Right"><%=FormatNumber(Trim(dcrs(3)),2,,,0)%></td>
   														                    <td class="ExcelDisplayCell" align="Right"><%=FormatNumber(Trim(dcrs(4)),2,,,0)%></td>
   														                    <td class="ExcelDisplayCell" align="Right"><%=FormatNumber(Trim(dcrs(5)),2,,,0)%></td>
   														                    <td class="ExcelDisplayCell" align="Right"><%=FormatNumber(Trim(dcrs(6)),2,,,0)%></td>
   													                    </tr>
   													                    <%
   													                    dcrs.MoveNext
												                    Loop
									...
									<tr>
										...
										<td valign="top">
											...
											<%end if'if trim(iTotalPages) > 1 then%>
											 <tr>
											    <td>
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
									                <tr>
