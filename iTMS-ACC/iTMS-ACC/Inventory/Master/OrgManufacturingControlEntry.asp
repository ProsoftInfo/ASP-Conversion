...
<%	option explicit	%>
<%
	'Program Name				:	OrgManufacturingControlEntry.asp
	...
	'							:
	'Connects To				:	OrgManufacturingControlInsert.asp
...
<HTML><HEAD><TITLE>Organization Control Definition - Manufacturing</TITLE>
...
function CheckSubmit(){
     if (!(document.forms[0].chkIn.checked || document.forms[0].chkEx.checked))
      {
		alert("Select Type Of Manufacturing");
		document.forms[0].chkIn.focus();
		return false;
	  }
	 else 
	 {
		document.forms[0].action = "OrgManufacturingControlInsert.asp"
		document.forms[0].submit();
	 }
}

</SCRIPT>
<SCRIPT LANGUAGE=javascript>window.ITMS_STORAGE_APPS = "MA";</SCRIPT>
		                       ...
		                       <td class="TabCell" valign="bottom" width="70">
								...
								<td class="TabCurrentCell" valign="bottom" align="center" width="105">
								  <table border="0" cellpadding="0" cellspacing="0" width="100%" class="TabCurrentTable" >
								   <tr>
									  <td width="100%" align="center">Manufacturing</td>
									</tr>
								  </table>
								</td>
										...
										<td>
											<table cellpadding="0" cellspacing="0" width="100%">
												<tr>
													...
													<td class='GroupTitle' width="145"><p align="center">Type of Manufacturing
											        </td>
												...
												<div align="left">
													...
													<tr>
														<td class=FieldCellSub> <p align="left">
															<input type="checkbox" name="chkIn" value="1" class="FormElem"> Internal&nbsp;
														</td>
														<td class='FieldCellSub'> &nbsp;&nbsp; </td>
														<td class='FieldCellSub'>
															<input type="checkbox" name="chkEx" value="1" class="FormElem"> External&nbsp;
														</td>
													</tr>
													</table>
												</div>
									...
									<DIV class=frmBody id=frm2 style="width: 440; height:64;">
								        <table border="0" cellspacing="1" class="ExcelTable" Id ="tblLoc" name="tblLoc">
										    <tr>
												...
												<td class="ExcelHeaderCell" align="center" width="100%">Manufacturing Storage Location</td>
										    </tr>
										    <!--tr>
												<td class="ExcelSerial" align="center">1</td>
												<td class="ExcelDisplayCell" width="100%">xName</td>
										    </tr-->
								        </table>
									</div>
								</td>
