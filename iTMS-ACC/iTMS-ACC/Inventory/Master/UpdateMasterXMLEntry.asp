...
<%
	...
	'Module Name				:	Inventory (Update Master XML Display)
...
<SCRIPT LANGUAGE="javascript">
	...
	{
		if (!((document.formname.ChkCategory.checked) || (document.formname.ChkStorage.checked) || (document.formname.ChkUOM.checked)))
		{
			alert ("Select any one");
			document.formname.ChkCategory.focus();
			return false;
		}
		else
										...
										<tr>
											<td width="100%" align="center">
													<table border="0" cellspacing="1" id="tblData" class="ExcelTable" width=50%>
														...
														<tr>
															<td class='ExcelDisplayCell' align="center"><input type="Checkbox" name="ChkCategory" class="Formelem" value="1"></td>
															<td class='ExcelDisplayCell'> Category</td>
														</tr>
														<tr>
															<td class='ExcelDisplayCell' align="center"><input type="Checkbox" name="ChkStorage" class="Formelem" value="1"></td>
															<td class='ExcelDisplayCell'> Storage</td>
														</tr>
														<tr>
															<td class='ExcelDisplayCell' align="center"><input type="Checkbox" name="ChkUOM" class="Formelem" value="1"></td>
															<td class='ExcelDisplayCell'> UOM</td>
														</tr>
													</table>
											</td>
										</tr>
