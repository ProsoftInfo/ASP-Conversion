...
<SCRIPT type="text/plain" data-itms-legacy-client-script="1">
    Function CheckSubmit()
        ...
        sItemCode = document.formname.hItmCode.value
       ...
       sFSN = ""
        ...
        ndRoot.setAttribute "ItemCode", document.formname.hItmCode.value
        ndRoot.setAttribute "ClassCode",document.formname.hClassCode.value
        ndRoot.setAttribute "OrgCode",document.formname.hOrgCode.value
        ...
        if trim(objhttp.responseText)<>"" then
            ...
            window.location.href = "ItmManufacture.asp?ItemCode="& document.formname.hItmCode.value &"&ClassCode="& document.formname.hClassCode.value
        end if
...
'		end if
	...
	Function CheckBack()
			window.location.href = "ItmDetailedDefn.asp?ItemCode="& document.formname.hItmCode.value &"&ClassCode="& document.formname.hClassCode.value
	End Function
