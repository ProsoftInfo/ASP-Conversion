...
%>
<%
	'Program Name				:	ItmTypOptionPoPEntryUpdate.asp
...
<input type=hidden name="hItemType" value="<%=sTypeName%>">
<input type=hidden name="hHeader" value="<%=sHdrName%>">
<input type=hidden name="hAttribute" value="<%=sAttrName%>">
										...
										<table border="0" cellspacing="1" id="tblData" class="ExcelTable">
											<tr>
												...
												<td class="ExcelHeaderCell" align="center" width="10">
													<img border="0" onClick="DelItem()" src="../../assets/images/iTMS%20Icons/DeleteIcon.gif" style="cursor: hand" width="11" height="11">
												</td>
