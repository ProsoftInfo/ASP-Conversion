...
%>
<%
	'Program Name				:	ItemListEntryForCreate.asp
				...
				<td align="center" height="20">
				     <table>
			            <tr>
			                <td class="PageTitle" >
			                    <%If sACTN = "PA" Then%>
						            <p align="center">Physical Adjustment
					            <%ElseIf sACTN = "MI" Then%>
						            <p align="center">Move Item
						        <%ElseIf sACTN = "ME" Then%>
						            <p align="center">Merge Item
					            <%ElseIf sACTN = "M" Then%>
						            <p align="center">Manage Item
					            <%Else%>
								...
								<tr>
									...
									<td class="TabCell" valign="bottom" width="90">
										<table border="0" cellpadding="0" cellspacing="0" width="100%" class="TabTable" onMouseOver="tabrollover(this)" onMouseOut="tabrollout(this)">
											<tr><a href="ItmCreationDefinitionEntry.asp">
