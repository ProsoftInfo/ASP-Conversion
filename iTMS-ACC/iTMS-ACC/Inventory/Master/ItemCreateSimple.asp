																...
																<table border="0" cellspacing="0" cellpadding="0">
																            ...
																            <table border="0" cellpadding="0" cellspacing="0">
																                <tr>
																		            ...
																		            <td class="FieldCellSub" colspan=2>
																			            <select size="1" name="selIType" class="FormElem" onChange="LetIType(this);ChangeLabel(this)">
																	...
																	<tr>
																		<td class="FieldCell" colspan="2" valign="top">
																		    <div class="frmBody" id="frm4" style="width: 550; height:100;">
																			    <table border="0" cellspacing="1" class="bodyTable" width="100%">
																				    <tr>
																				        <td class="ExcelDisplayCell" align="center" colspan="2">Attributes [<a href="#" onclick="ManageAttribute()">Manage</a>] </td>
																				    </tr>
																				    <tr>
																					    <td class="FieldCellSub">
															...
															<td class="FieldCellSub">
																<table border="0" cellspacing="0" cellpadding="0">
																	...
																	<tr>
																		...
																		<td class="FieldCell">
																			<input type="radio" value="1" name="radBoM" class="FormElem">   Yes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
																			<input type="radio" value="0" name="radBoM" class="FormElem" checked>   No
																...
																<table border="0" cellspacing="1" id="Table1" class="ExcelTable" width="100%">
																	...
																	<tr>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtPurRate" value="0" class="formelem" size="15" style="text-align:right" onblur="AssaignValue()">
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtPurRatePer" value="1" class="formelem"  size="3" style="text-align:right">&nbsp;
																		    <span id="spanPurUOM" class="dataonly"></span>
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtChaPer" value="0" class="formelem" size="3" style="text-align:right" onblur="CalcValue('OP')">
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtChaVal" value="0" class="formelem"  size="15" style="text-align:right" onblur="CalcValue('OV')">
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtMarPer" value="0" class="formelem" size="3" style="text-align:right" onblur="CalcValue('MP')">
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtMarVal" value="0" class="formelem"  size="15" style="text-align:right" onblur="CalcValue('MV')">
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <input type="text" name="txtTotPrice" value="0" class="formelem"  size="15" style="text-align:right">
																		</td>
																		<td class="ExcelDisplayCell" align="center">
																		    <%
