...
<%	option explicit	%>
<%
	'Program Name				:	VouCNOtherDisplay.asp
...
dim sPartyCode,sPartyName,sParType,sParSubType,sParCode,sTemp
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		<td align="center" class=PageTitle height="20"><p align="center"> Other Credit Note
						...
						<table border="0" cellpadding="0" cellspacing="0" width="100%">
                            ...
                            <td>
								<span class="DataOnly"><%=sVoucDate%></span>
                                    ...
                                    <tr>
                            <td class="FieldCellSub" width="115">Party Name </td>
                            <td class="FieldCell" colspan="3"><span class="DataOnly"><%=sPartyName%></span>
                            </td>
                                    </tr>
							...
							<tr>
								...
								<td valign="top" class="FieldCell" height="20">
                                                ...
                                                <table border="0" cellspacing="1" class="ExcelTable" width="780">
                                            <tr>
...
<%
dim sAccType,nodADD,dCRAmt,dDRAmt,dTdsAmt,dTdsPer
dim sExp,tempnode,iCounter,CheckNode
sExp="//Entry"
...
for iCounter=0 to tempnode.length-1
	...
	IF CheckNode.length <> 0 Then
		dTdsAmt = EntryNode.Attributes.getNamedItem("TdsAmount").value
		dTdsPer = EntryNode.Attributes.getNamedItem("TdsPercentage").value
	Else
		dTdsAmt = 0
		dTdsPer = 0
	End IF
	...
	if EntryNode.Attributes.getNamedItem("CRDR").value="C" then
		dCRAmt=dCRAmt+CDbl(sAmount)
	else
		dDRAmt=dDRAmt+CDbl(sAmount)
	end if
