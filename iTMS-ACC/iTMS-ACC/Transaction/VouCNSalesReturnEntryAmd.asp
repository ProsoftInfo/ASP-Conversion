...
<%	option explicit	%>
<%
	'Program Name				:	VouCNSalesReturnEntryAmd.asp
...
Dim dInvInvAmount,iSalInvoiceNo,iSalReturnNo
...
sQuery = "Select RefNumber from ACC_T_CreatedVoucherCRDRNotes where RefType='SR' and CreatedTransNo  = "& iTransNo
objRs.Open sQuery,con
if not objRs.EOF then
    iSalReturnNo = objRs(0)
end if
objRs.Close 

sQuery  = "Select isNull(Sum(InvoicedQuantity),0),isNull(Sum(InvoicedRate),0),isNull(Sum(DiscountPercent),0) from Sal_T_SalesReturnDetail where SalesReturnNo = "& iSalReturnNo 
...
sRetVal = GetVouchSalReturnXML(iSalReturnNo)
...
<table border="0" width="100%" cellspacing="0" cellpadding="0">
	<tr>
		...
		Credit Note For Sales Return Amendment
          		</td>
    </tr>
	<tr>
