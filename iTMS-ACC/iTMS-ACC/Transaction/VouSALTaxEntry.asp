...
<%	option explicit	%>
<%
	'Program Name				:	VouSALTaxEntry.asp
...
dim sDiscPer,dBasicTotal,dDisTotal, iRndOff
dim sTaxName,sCatCode,sTaxCode,dTax,sTaxMode,sFormula,dTaxValue
dim sInvoiceNo,sAppTy,sRndChk
Dim sExp,sAgentNode,sAgent,sUserID,sAccUnit,sAccUnitName

sUserId = getUserID()
sAccUnit = Request.Form("hAccUnit")
sAccUnitName = Request.Form("hAccUnitName")
	...
	if oNodDeatils.nodeName="Header" then
		for Each oNodEntry in  oNodDeatils.childNodes
			if oNodEntry.nodeName="Organization" then
				'oNodEntry.Attributes.Item(0).nodeValue = sAccUnit
				'oNodEntry.text = sAccUnitName
...
sExp = "//AgentDetails"
Set sAgentNode = oNodRoot.selectNodes(sExp)
IF sAgentNode.length <> 0 Then
	sAgent = "T"
Else
	sAgent = "F"
End IF

Dim dTotNewBasVal,TempNode,iCtr
dTotNewBasVal = 0
sExp = "//Entry"
...
<XML id="TaxData" src="<%="../temp/transaction/Voucher Entry_SAL_"&Session.SessionID&".xml"%>"></XML>
...
Function SaveXML()
	...
	if objhttp.responseText <> "" then
		...
		IF CStr(document.formname.hSubType.Value) = "T" Then
			document.formname.action = "VouSALCommAdvance.asp"
		Else
			document.formname.action = "VouSALAdvance.asp"
		End IF
...
<form method="POST" name="formname" action="VouSALAdvance.asp">
<Input type="hidden" name="hApprover" value="<%=sAppTy%>">
<Input type="hidden" name="hSubType" value="<%=sAgent%>">
		...
		<td valign="top">
			<TABLE id=Table16 cellSpacing=0 cellPadding=0 border=0 width="100%"  >
				...
				<TR>
                    ...
                    <td class="ToolBarCell" width="40" onClick="toolClick(this)" onMouseOver="toolrollover(this)" onMouseOut="toolrollout(this)" >
                    <p align="center">
                    <span style="cursor: hand" Title="Daywise Balance"><font size="3" face="Webdings">?</font>                    </span>
                    </p>
                    </td>
                    <td class="ToolBarCell" width="40" onClick="toolClick(this)" onMouseOver="toolrollover(this)" onMouseOut="toolrollout(this)" >
                    <p align="center">
                ...
                <td></td>
                <td valign="top" width="100%">
                <div class="frmBody" id="frm2" style="width: 580; height:280;">
...
<%
	...
	For Each oNodEntry in oNodDeatils.childNodes
		...
		sTotalQty = CDbl(sTotalQty + oNodEntry.Attributes.GetNamedItem("Qty").value)
...
%>
        ...
        <tr>
    <td class="ExcelSerial" align="center" colspan="4" class="ExcelSerial"></td>
...
dim dInvAmount,iRoundedInvvalue,iRoundedoff
	...
	For Each oNodEntry in oNodTaxRoot.childNodes
		...
		if sTaxMode="P" then
			dTax=CalculateTax(oNodTaxRoot,sFormula,dTotNewBasVal,dTotal,dTaxValue)
		elseif sTaxMode = "Q" then
			dTax = CDbl(sTotalQty * dTaxValue)
		else
			dTax=dTaxValue
		end if
...
%>
  <tr>
        <td align="center" colspan="3" class="ExcelSerial"></td>
    <td class="ExcelSerial" align="center" colspan="5">
    <p align="right"><b>Rounded Off&nbsp; </b></td>
    <td class="ExcelInputCell" align="right"> <input type="text" style="text-align: Right" NAME="txtroundoff"  size="11" value="<%=iRoundedoff%>"  class="Formelem" readonly>
        </tr>
													...
													<tr>
														<td valign="middle" class="ActionCell">
                                                            <p align="center">
                                                                ...
                                                                <input type="button" value="Cancel" name="B6" class="ActionButton" onClick="Cancel('VouSALBookSelection.asp')" >
														</td>
													</tr>
												</table>
								</td>
