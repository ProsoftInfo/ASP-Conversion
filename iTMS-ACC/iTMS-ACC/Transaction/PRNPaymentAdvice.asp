...
%>
<%
	'Program Name				:	PRNPaymentAdvice.asp
	'Module Name				:
...
set		objTxt	= objFSO.CreateTextFile(server.MapPath("../temp/Transaction/"&Session.SessionID&"_BankPaymentAdvice.txt"))
...
'sTempStr = sTempStr & myAlign(" ",7,"L") & myAlign("Authorised Signatory",20,"L") & vbCrLf & vbCrLf & vbCrLf
...
'stempstr = stempstr & myalign(" ",7,"L") & myalign("Authorised Signatory",38,"R")  & vbCrLf & vbCrLf & vbCrLf & vbCrLf & vbCrLf & vbCrLf & vbCrLf & vbCrLf
stempstr = stempstr & myalign(" ",7,"L") & myalign("Authorised Signatory",38,"R")  & vbCrLf & vbCrLf

'Added By UmaMaheswari S on 5th January 2011
...
'sTempStr = sTempStr & myAlign(" ",7,"L")  & myAlign("Printed By :",12,"L") & myAlign(sUser,40,"L") & vbCrLf  
'sTempStr = sTempStr & myAlign(" ",50,"L") & myAlign("Print Date :",12,"L") & myAlign(dtPrnDate,20,"L") & vbCrLf  
'sTempStr = sTempStr & myAlign(" ",50,"L") & myAlign("Print Time :",12,"L") & myAlign(tmPrnTime,20,"L") & vbCrLf & vbCrLf & vbCrLf

'-------------Function End--------------------

sTextOut = sTextOut & sTempStr  
objTxt.write sTextOut
Response.Redirect("../../Components/FormattPrintNew.asp?server=server&filepath=/accounts/temp/Transaction/"&Session.SessionID&"_BankPaymentAdvice.txt&exitpath=/accounts/reports/VouBAView.asp&frame=_parent")
%>
<%
Function Header()
