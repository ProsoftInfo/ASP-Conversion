...
IF CStr(sCallTy) <> "P" Then
	sQuery="select distinct PartyType,PartySubType,SubTypeName from vwOrgParty where OUDefinitionID='"&sOrgId&"'"
Else
	sQuery = "select distinct PartyType,PartySubType,SubTypeName from vwOrgParty where OUDefinitionID='"&sOrgId&"' "&_
